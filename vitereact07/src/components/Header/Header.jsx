...
//React provide the feature of Link instead of <a> because <a> reloads the entire page. React also 
// provides NavLink with some additional features like highlighting the active nav page.
                    ...
                    >
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <NavLink
                                 to="/"
    //arrow function syntax inside className allow identifaction of Active Page,Initially when the first time
    //rendering happens you see Home Navbar link is orange-700 when you click some other Navbar link then active
    //page is changed and now its navbar link is orange-700
                                    className={({isActive}) =>
